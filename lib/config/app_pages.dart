...
// Finance
import '../features/finance/finance_binding.dart';
import '../features/finance/finance_view.dart';
...
class AppPages {
  static final routes = [
    ...
    GetPage(name: Routes.kyc, page: () => const KycView(), binding: KycBinding()),
          ...
          GetPage(name: Routes.finance, page: () => const FinanceView(), binding: FinanceBinding()),
